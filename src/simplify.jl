## remove this once integrated in
## move tests to /test
import SimpleExpressions: AbstractSymbolic, SymbolicNumber, SymbolicParameter, SymbolicVariable, SymbolicExpression, SymbolicEquation
using TermInterface


# two new dependencies, both quite light
# put into SimpleExpressions, but after we debug and tag new release
using Metatheory # requires 3.0 which is not released
